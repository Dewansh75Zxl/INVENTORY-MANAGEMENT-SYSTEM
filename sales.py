...
class salesClass:
    def __init__(self,root):
        ...
        txt_invoice=Entry(self.root,textvar=self.var_invoice,font=("times new roman",15),bg="lightyellow").place(x=160,y=100,width=180,height=28)
        ...
        #==Image==
        self.bill_photo=Image.open("images/bill2.jpg")
