...
class IMS:
    def __init__(self,root):
        ...
        #========Left Menu==========
        self.MenuLogo=Image.open("images/menus.png")
        ...
        lbl_menu=Label(LeftMenu,text="Menu",font=("times new roman",20),bg="#009968",).pack(side=TOP,fill=X)
        ...
        lbl_footer=Label(self.root,text="IMS-Inventory  Management  System  Developed  By  Dewansh Thapa , Shahel Tamrakar , Niran Joshi  And  Prabin Bhandari\nFor Any Technical Issue Contact Them ",font=("times new roman",12,),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
