...
class productClass:
    def __init__(self,root):
        ...
        product_Frame=Frame(self.root,bd=2,relief=RAISED,bg="white")
        product_Frame.place(x=10,y=10,width=450,height=480)

        #===title===

        title=Label(product_Frame,text="Products Details",font=("goudy old style",18),bg="#0f4d7d",fg="white").pack(side=TOP,fill=X)
        ...
        lbl_producr_name=Label(product_Frame,text="Name",font=("goudy old style",18),bg="white",).place(x=30,y=160)
        ...
        #==========searchFrame======
        SearchFrame=LabelFrame(self.root,text="Search Employee",font=("goudy old style",12,"bold"),bd=2,relief=RAISED,bg="white")
...
#==========================================================================
    ...
    def delete(self):
       ...
       try:
          if self.var_pid.get()=="":
                messagebox.showerror("Select Product from the list",parent=self.root)
          else:
                cur.execute("Select * from product where pid=?",(self.var_pid.get(),))
                row=cur.fetchone()
                if row==None:
