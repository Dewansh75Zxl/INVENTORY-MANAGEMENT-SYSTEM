...
class BillClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Inventory Management System",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w").place(x=0,y=0,relwidth=1,height=70)
        ...
        #===clock======
        self.lbl_clock=Label(self.root,text="Welcome to Inventory Management System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15,),bg="#4d636d",fg="white",anchor='w')
        ...
        btn_eq=Button(Cal_Frame,text='eq',font=('arial',15,'bold'),command=self.perform_cal,bd=5,width=4,pady=15,cursor="hand2").grid(row=4,column=2)
        ...
        lbl_p_name=Label(Add_CartWidgetsFrame,text="Products Name",font=("times new roman",15),bg="white").place(x=5,y=5)
        ...
        #========FOOTER===================
        footer=Label(self.root,text="IMS-Inventory Management System|Developed By Dewansh,Shahel,Niran and Prabin\nFor any Technical Issue Contact Them",font=("times new roman",11),bg="#4d636d",fg="white",bd=0,cursor="hand2").pack(side=BOTTOM,fill=X)
...
#=========================ALL FUNCTIONS====================
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            fp.close()
            messagebox.showinfo('Saved',"Bill has been genearted/Saved",parent=self.root)
            self.chk_print=1
  ...
  Phone No. 9840036452 , Chyasal-09,Lalitpur
{str("="*47)}
